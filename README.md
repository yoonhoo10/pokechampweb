...
포켓몬을 고르기 애매하면 **🎲 랜덤으로 시작하기** — ① 무작위 코어 1마리로 파티 추천받기, ② 6마리 완전 랜덤 파티 뽑기 도 지원합니다.
...
1. **포켓몬 선택** — 검색 + 그리드에서 코어 1~3마리 선택 (또는 🎲 랜덤 코어 / 🎲 6마리 완전 랜덤 파티)
2. **파티 추천 결과** — 균형형 / 메타 시너지형 / 상성 안정형 옵션 비교 (완전 랜덤은 옵션 1개)
...
- `POST /api/random-party` — (바디 없음) 6마리 완전 무작위 파티 옵션 1개
...
6. `move_tags` + 종족값으로 선봉/스피드컨트롤/승리 플랜 텍스트 생성
